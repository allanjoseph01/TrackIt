  ...
  return (
    <AuthLayout>
      <div className='lg:w-full h-auto md:h-full mt-10 md:mt-0 flex flex-col justify-center'>
        <h3 className='text-4xl font-semibold text-white mt-2'>Create an Account</h3>
        ...
        <form onSubmit={handleSignUp}>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            label = "Full Name" placeholder = "John" type="text" />
          ...
          <p className='mt-8 text-slate-400 text-[13px]'>Already have an account?{" "}
            <Link className='font-bold text-cyan-400 hover:text-cyan-300 ml-1 transition-colors' to="/login">Login</Link>
          </p>
        </form>
      </div>
    </AuthLayout>
