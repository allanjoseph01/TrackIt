  ...
  return (
    <AuthLayout>
      <div className='lg:w-[70%] h-3/4 md:h-full flex flex-col justify-center'>
        <h3 className='text-4xl font-extrabold text-white tracking-tight'>Welcome Back</h3>
        ...
        <form onSubmit={handleLogin}>
          ...
          <p className='mt-8 text-center text-slate-400 text-sm'>Don't have an account?{" "}
            <Link className='font-bold text-cyan-400 hover:text-cyan-300 ml-1 transition-colors' to="/signup">SignUp</Link>
          </p>
        </form>
      </div>
    </AuthLayout>
